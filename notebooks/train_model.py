...
# ✅ 8 features officielles — sans frissons et nausee
...
print(f"Nombre de features : {model.n_features_in_}")  # doit afficher 8
...
# Verification — simuler un nouveau patient
model_loaded = joblib.load("models/model.pkl")
le_sexe_loaded = joblib.load("models/encoder_sexe.pkl")
le_region_loaded = joblib.load("models/encoder_region.pkl")

print(f"\nModele recharge : {type(model_loaded).__name__}")
print(f"Nombre de features : {model_loaded.n_features_in_}")  # doit afficher 8
print(f"Classes : {list(model_loaded.classes_)}")

# ✅ Patient test sans frissons et nausee
nouveau_patient = {
    'age': 28,
    'sexe': 'F',
    'temperature': 39.5,
